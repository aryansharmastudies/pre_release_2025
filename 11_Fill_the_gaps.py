'''
If you remove a number from the middle of the list, shift everything on the right to fill the gap.

| | | | | |48|19|16|37|49|48|48|17|40|8|17|18|13|22|33|

In the above example, removing 16 would make this:

| | | | | |48|19|  |37|49|48|48|17|40|8|17|18|13|22|33|NEW

Instead, do this: 
| | | | | |48|19|37|49|48|48|17|40|8|17|18|13|22|33|NEW (left number hasn't shifted, but the ones to the right of the removed one has)
'''
...
def Main():
    ...
    if Choice == "y":
        ...
        MaxTarget = 1000
        TrainingGame = True
        Targets = [-1, -1, -1, -1, -1, 23, 9, 140, 82, 121, 9, 45, 68, 75, 34, 23, 9, 43, 23, 119]
    else:
        MaxNumber = 10
        MaxTarget = 50
...
def PlayGame(Targets, NumbersAllowed, TrainingGame, MaxTarget, MaxNumber):
    ...
    while not GameOver:
        ...
        if Targets[0] != -1:
            ...
            Targets = UpdateTargets(Targets, TrainingGame, MaxTarget, IsTarget)        
    print("Game over!")
    DisplayScore(Score)
    ...
    if UserInputEvaluation != -1:
        for Count in range(0, len(Targets)):
            if Targets[Count] == UserInputEvaluation:
                ...
                Targets_copy.append(Targets[Count])
    print(f'🤩🤩🤩 {Targets_copy}')
    return UserInputEvaluationIsATarget, Score, Targets_copy
...
def UpdateTargets(Targets, TrainingGame, MaxTarget, IsTarget):
    if IsTarget:
        if TrainingGame:
