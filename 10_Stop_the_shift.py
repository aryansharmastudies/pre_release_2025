...
def Main():
    ...
    if Choice == "y":
        ...
        MaxTarget = 1000
        TrainingGame = True
        Targets = [-1, -1, -1, -1, -1, 23, 9, 16, 82, 9, 34, 24, 68, 75, 2, 23, 119, 8, 24, 119]
    else:
        MaxNumber = 10
        MaxTarget = 50
    ...
    while not GameOver:
        ...
        if CheckIfUserInputValid(UserInput):
            ...
            if CheckNumbersUsedAreAllInNumbersAllowed(NumbersAllowed, UserInputInRPN, MaxNumber):
                IsTarget, Score, Occurance = CheckIfUserInputEvaluationIsATarget(Targets, UserInputInRPN, Score)
                if IsTarget:
...
def CheckIfUserInputEvaluationIsATarget(Targets, UserInputInRPN, Score):
    ...
    return UserInputEvaluationIsATarget, Score, Occurance
