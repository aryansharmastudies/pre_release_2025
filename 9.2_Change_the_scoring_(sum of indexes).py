'''
9.2 - Change the scoring (sum of indexes)
Add the index of the target cleared to the score instead of 1. 
E.g. if the targets are [ , 4,3,35,14,5] and you clear 3, that would add 2 to the score and the list would look like this [4, , 35, 14, 5, 6]. 
Clearing 14 here would add 3 to the score.
'''
...
def Main():
    ...
    if Choice == "y":
        ...
        MaxTarget = 1000
        TrainingGame = True
        Targets = [-1, -1, -1, -1, -1, 23, 9, 140, 82, 9, 34, 45, 68, 75, 9, 23, 119, 43, 23, 119]
    else:
        MaxNumber = 10
        MaxTarget = 50
